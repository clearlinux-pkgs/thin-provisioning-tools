...
Version  : 0.7.4
Release  : 1
URL      : https://github.com/jthornber/thin-provisioning-tools/archive/v0.7.4.tar.gz
Source0  : https://github.com/jthornber/thin-provisioning-tools/archive/v0.7.4.tar.gz
...
%prep
%setup -q -n thin-provisioning-tools-0.7.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1510525557
